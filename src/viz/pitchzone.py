...
def _build_labels(
    ...
    label_specs = [
        # metric, side, approx label Y
        ("shoulder_abduction_fp",    "left",  jt("throw_shoulder")[1] - 10),
        ("elbow_flexion_fp",         "left",  jt("throw_elbow")[1] - 5),
        ("stride_length_pct_height", "left",  jt("lead_knee")[1] + 30),
        ("torso_anterior_tilt_fp",   "right", jt("chest")[1] + 10),
        ("hip_shoulder_separation_fp", "right", jt("pelvis")[1] + 8),
        ("lead_knee_angle_fp",       "right", jt("lead_knee")[1] + 5),
    ]
